  ...
  <header className="header">
    <div className="header__container">
      ...
      <div className={`header__panel ${menu? 'activa':''}`}>
        ...
        {localStorage.getItem("Usuario") == null ? (<></>) : (<li className="header__elementoLista"><Link className="header__linkLista" to={'/miPerfil'}><button className="header__perfil" type="button"onClick={()=>{{perfiles  == null? <img width={30} src='/logo.png' alt="imagen del perfil"/> :<img width={30} src={perfiles.Foto} alt="perfil"/>}}}></button></Link></li>)}
