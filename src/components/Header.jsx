  ...
  <header className="header">
    <div className="header__container">
      ...
      <div className={`header__panel ${menu? 'activa':''}`}>
        ...
        {localStorage.getItem("Usuario") == null ? (<></>) : (<li className="header__elementoLista"><Link className="header__linkLista" to={'/miPerfil'}>{perfiles  == null? <img className="header__img" width={10} src='/logo.png' alt="imagen del perfil"/> :<img className="header__img" width={10} src={perfiles.Foto} alt="perfil"/>}</Link></li>)}
